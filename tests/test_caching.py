from aiclient.data_types import SystemMessage, Text, UserMessage
...
def test_anthropic_caching_injection():
    ...
    messages = [SystemMessage(content="System Prompt", cache_control="ephemeral")]
    ...
    messages = [UserMessage(content="Hello", cache_control="ephemeral")]
...
def test_anthropic_multi_block_caching():
    ...
    messages = [
        UserMessage(
            content=[Text(text="Context 1"), Text(text="Context 2")],
